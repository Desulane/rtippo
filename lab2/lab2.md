...
#### Игрок - Ответ
Игрок записывает названия тех предметов, которые запомнил, и передаёт их системе. Список введённых игроком предметов сравнивается с действительным списком предметов, содержащихся в игре.
